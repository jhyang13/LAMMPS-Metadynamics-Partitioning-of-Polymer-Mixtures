...
#1_rearrange
#load file
#REP = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15']
REP = ['01', '02', '03']

for i in REP:
    fread1 = open('D:\\all\\projects\\python_research_code\\py_count_contacts_in_pore\\20221119_NA120_PHIA0.05_NB40_PHIB0.05_R3_EPS2.00_' + 'REP' + i + '\\long.lammpstrj', 'r')
    longread1 = fread1.readlines()
    fread2 = open('D:\\all\\projects\\python_research_code\\py_count_contacts_in_pore\\20221119_NA120_PHIA0.05_NB40_PHIB0.05_R3_EPS2.00_' + 'REP' + i + '\\short.lammpstrj', 'r')
    ...
    #write into a new file
    fwrite1 = open('long_contacts_in_pore' + '_' + i + '.txt', 'w')
    fwrite2 = open('short_contacts_in_pore' + '_' + i + '.txt', 'w')
